            ...
            <View style={{
                ...
                <View style={{flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <View style={{flex:1, justifyContent: 'flex-start'}}>
                        <Text style={{fontSize: 18,fontWeight: 'bold',marginLeft: 15}}>{'OCS Assistant'}</Text>
                        <Text style={{fontSize: 14,marginLeft: 15}}>{'Version: ' + this.props.version}</Text>
                        <Text style={{fontSize: 14,marginLeft: 15}}>{'Release: ????'}</Text>
                    </View>
                </View>
                <View style={{flex: 1}}>
                    <Text style={{fontSize: 18}}>{'An assistant for the Operational Combat Series games from MultiMan Publishing.'}</Text>
                </View>
                <View style={{flex: 1}}>
