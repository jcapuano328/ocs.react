...
let SeaView = React.createClass({
    ...
    resolve() {
        let results = Sea.amphiblanding(this.state.terrain,+this.state.coastalarty,this.state.ship,this.state.nondgadj,this.state.dgadj,
                                        this.state.zoc,this.state.elite,this.state.die1,this.state.die2);
